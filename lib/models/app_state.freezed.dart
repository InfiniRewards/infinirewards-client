...
class _$AppStateDataImpl extends _AppStateData {
  _$AppStateDataImpl(
      ...
      @HiveField(4) this.isMerchant = false})
      : super._();
  ...
  @override
  String toString() {
    return 'AppStateData(navigatorIndex: $navigatorIndex, token: $token, theme: $theme, autoLoginResult: $autoLoginResult, isMerchant: $isMerchant)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, navigatorIndex, token, theme, autoLoginResult, isMerchant);
...
abstract class _AppStateData extends AppStateData {
  factory _AppStateData(
      ...
      @HiveField(4) final bool isMerchant}) = _$AppStateDataImpl;
